...
const CSS_RMX_PREFIX = "RMX-theMonitor-"

const RMX_The_Monitor = ({ className, menuOpen, seed, isActive }) => {
  ...
  const sketch = (p5sketch, initSeed) => {
    ...
    const imageUrl =
      "https://ordinals.com/content/6e5f5a02f88d3058084c53792e74b83f1b40d8951dc1f4c46047ca2e87ca36d3i0";
...
export default memo(RMX_The_Monitor)
